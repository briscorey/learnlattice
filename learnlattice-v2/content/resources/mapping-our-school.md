...
hook: "Students create a scale map of their school using measurement, scale factor, and coordinate geometry, applying mathemati"
seo_title: "Mapping Our School | MYP Resource | LearnLattice"
seo_description: "Students create a scale map of their school using measurement, scale factor, and coordinate geometry, applying mathematics to a real spatial problem."
teacher_moves:
...
parent_summary: 'Your child is working on "Mapping Our School" — a mathematics investigation designed for Grade 6 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students create a scale map of their school using measurement, scale factor, and coordinate geometry, applying mathematics to a real spatial problem.

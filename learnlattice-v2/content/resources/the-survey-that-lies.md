...
seo_title: "The Survey That Lies | Free MYP Maths Investigation"
...
### Design a fair survey for your school on a topic YOU choose.

Requirements:
- At least 30 respondents
- Random sampling method (describe how)
- Neutral question wording (test it on a partner first)
- Report BOTH mean and median
- Create an honest graph AND a deliberately misleading one
- Write a paragraph explaining why the misleading graph is wrong

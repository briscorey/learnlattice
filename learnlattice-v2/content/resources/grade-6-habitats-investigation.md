...
teacher_moves:
  ...
  - title: "The comparison is the learning"
    description: "Individual observations are interesting but the real thinking happens when students compare sites. Why did Site A have woodlice but Site B did not? Force the comparison with a structured table: organism, Site A count, Site B count, Site C count. The patterns emerge from the table."
listen_for:
  - level: "3-4"
...
misconceptions:
  ...
  - myth: "Small organisms are not important"
    why: "Students focus on visible, charismatic organisms"
    truth: "Decomposers and micro-organisms in soil drive nutrient cycling. The invisible organisms are often the most ecologically significant."
sentence_starters:
  approaching:
    - "In Habitat A, I found..."
    - "The conditions under the rock were..."
  meeting:
    - "Habitat A had more ___ than Habitat B because..."
    - "The abiotic factor that made the biggest difference was..."
  exceeding:
    - "The distribution of organisms is determined by..."
    - "If the conditions at Site A changed to become more like Site B, I would predict..."
self_check:
  - level: "Getting started"
    items:
      - "I recorded organisms at all three sites"
      - "I described the conditions at each site"
  - level: "Building understanding"
    items:
      - "I compared the organisms across sites"
      - "I can explain why different organisms were found in different places"
  - level: "Going deeper"
    items:
      - "I linked specific abiotic factors to specific organisms"
      - "I can predict what would happen if conditions changed"
exit_ticket:
  - "Name one abiotic factor that was different between your two most contrasting sites."
  - "Explain why woodlice are found under rocks but not on sunny paths."
  - "Predict: if a tree was cut down, how would the habitat underneath change over the next year?"
quick_check:
  - type: "recall"
    q: "What is the difference between a biotic and an abiotic factor?"
...
differentiated:
  approaching: "Record what you find at each site. Draw a labelled diagram of one micro-habitat showing the organisms and conditions."
  meeting: "Compare all three sites using a table. Identify which abiotic factor has the biggest effect on which organisms are present. Use evidence from your data."
  exceeding: "Evaluate the limitations of your sampling method. How could you improve reliability? Design a follow-up investigation to test whether one specific abiotic factor (e.g. light level) determines the distribution of one specific organism."
journal_prompts:
...
**Why do organisms cluster in specific places?** What is it about *under the rock* that works, and *the path* that does not?
...
- String or hula hoops to mark 1m² quadrats
- Clipboard, recording sheet, pencil
- Magnifying glasses (optional but valuable)
- Thermometer (optional)
- Moisture meter or just observation (damp/dry/wet)

### Method

1. **Choose 3 micro-habitats** within 50 metres of your classroom:
   - Site A: Under a rock, log, or overturned pot
   - Site B: Base of a wall or fence in shade
   - Site C: Open sunny area (path edge, field)

2. At each site, mark a 1m² area and spend **8 minutes** recording:
   - Every organism you can see (identify or describe)
   - Estimated count of each
   - Conditions: light level (sunny/shady/dark), moisture (dry/damp/wet), temperature (if you have a thermometer), ground cover

3. **Do not disturb unnecessarily.** Look, count, record, then carefully replace any rocks or logs.

### Recording Table

| Organism | Site A (under rock) | Site B (shaded wall) | Site C (sunny path) |
|---|---|---|---|
| Woodlice | | | |
| Ants | | | |
| Earthworms | | | |

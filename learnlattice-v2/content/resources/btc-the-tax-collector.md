...
statement_of_inquiry: "Understanding the relationships between numbers allows us to make strategic decisions that optimise outcomes."
difficulty: "meeting"
duration: "1 lesson"
...
> **Example:** You claim 18. The Tax Collector takes 1, 2, 3, 6, 9 (the factors of 18 that are still available). You got 18, but the Tax Collector got 1+2+3+6+9 = 21. Bad move!

---

## Play and Strategise

Play three rounds at your whiteboard. Track your results:

| Round | Your Numbers | Your Total | Tax Collector's Numbers | TC Total | Winner |
|---|---|---|---|---|---|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
> **Key questions:**
> - Which numbers should you claim first? Last?
> - Why are prime numbers valuable?
> - What is the MAXIMUM score you can achieve against the Tax Collector?
...
**BTC Practices Used:** Game-based thinking task, random groups, vertical non-permanent surfaces. The competitive element and the Tax Collector "character" create immediate engagement.

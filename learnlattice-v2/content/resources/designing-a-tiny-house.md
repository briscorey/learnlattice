...
hook: "Students apply area, volume, and scale drawing to design a tiny house within specific constraints, calculating material "
seo_title: "Designing a Tiny House | MYP Resource | LearnLattice"
seo_description: "Students apply area, volume, and scale drawing to design a tiny house within specific constraints, calculating material costs and optimising space."
teacher_moves:
...
parent_summary: 'Your child is working on "Designing a Tiny House". a mathematics investigation designed for Grade 8 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students apply area, volume, and scale drawing to design a tiny house within specific constraints, calculating material costs and optimising space.

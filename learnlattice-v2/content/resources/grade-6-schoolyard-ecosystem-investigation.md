...
### Equipment
- String quadrats (1m × 1m squares made from string and pegs)
- Magnifying glasses
- Observation log sheets (prepared with columns: organism, location, count, sketch)
...
### Analysis
1. Pool all group data into a class dataset
2. Calculate species richness for each location type
3. Which location had the most biodiversity? The least? Why?

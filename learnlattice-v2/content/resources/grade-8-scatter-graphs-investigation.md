...
teacher_moves:
  ...
  - title: "Draw TWO lines"
    description: "Students draw the line of best fit through the data AND the line y=x (where armspan perfectly equals height). The gap between these two lines IS the answer to whether da Vinci was right. For most classes, the line of best fit sits very close to y=x."
  - title: "The outliers are the teaching moments"
    description: "There will be students whose data points sit far from the line. Do NOT treat these as errors. Ask: why might someone's armspan be much longer than their height? (Growth patterns, genetics, sport.) Outliers teach students that correlation describes a trend, not a rule."
listen_for:
  - level: "3-4"
...
misconceptions:
  - myth: "Correlation means the points should be ON the line"
    why: "Students expect perfect relationships"
...
sentence_starters:
  approaching:
    ...
    - "The correlation is ___ (positive/negative/none)"
  meeting:
    - "The line of best fit suggests that for a height of 170cm, the predicted armspan is..."
    - "The correlation is strong because..."
  exceeding:
    - "The data supports da Vinci's claim because the line of best fit is close to y=x, however..."
    - "Extrapolating beyond the data range would be unreliable because..."
self_check:
  - level: "Getting started"
    items:
      - "I measured and recorded height and armspan accurately"
      - "I plotted all class data points on a scatter graph"
  - level: "Building understanding"
    items:
      - "I drew a line of best fit and can use it to make predictions"
      - "I can describe the correlation using correct terminology"
  - level: "Going deeper"
    items:
      - "I compared the line of best fit with the line y=x"
      - "I can explain why correlation does not prove causation"
exit_ticket:
  - "Describe the correlation between height and armspan using data from your graph."
  - "A new student is 165 cm tall. Use your line of best fit to predict their armspan."
  - "Why would it be unreliable to predict the armspan of a 220 cm basketball player from your data?"
quick_check:
  - type: "recall"
    q: "What are the three types of correlation?"
    a: "Positive (both increase together), negative (one increases as the other decreases), and no correlation (no pattern)."
  - type: "apply"
    q: "Your line of best fit passes through (150, 148) and (180, 179). Predict the armspan for someone 160 cm tall."
...
journal_prompts:
  ...
  - "Leonardo da Vinci made his claim 500 years ago without statistical tools. How did he figure it out?"
parent_summary: "Your child investigated the relationship between height and armspan by collecting and graphing class data. They learned about scatter graphs, correlation, lines of best fit, and the important distinction between correlation and causation. Ask them: was Leonardo da Vinci right?"
seo_title: "Height vs Armspan | Scatter Graphs Investigation | MYP Math Grade 8"
seo_description: "Free MYP Mathematics investigation for Grade 8. Students collect body measurement data, plot scatter graphs, and explore correlation and prediction."
---

## The Hook

Leonardo da Vinci's **Vitruvian Man** makes a bold claim: your armspan equals your height.

He drew it in 1490. No scatter graphs, no statistics, no calculator. Just observation.

Was he right? Let us test it with data.
...
1. **Line of best fit:** Draw a straight line that follows the trend of the data, with roughly equal numbers of points above and below the line
2. **The line y = x:** Draw a dashed line where armspan exactly equals height. This is da Vinci's prediction.

### Analyse

- What type of correlation does the graph show?
- How close is the line of best fit to the line y = x?
- Use the line of best fit to **predict** the armspan for someone 155 cm tall and someone 185 cm tall
- Are any points far from the line? Why might those students have unusual proportions?

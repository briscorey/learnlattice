...
hook: "Students investigate taxi pricing structures (flag fall plus per-km rate), compare companies, and advise which is cheape"
seo_title: "Modelling Taxi Fares | MYP Resource | LearnLattice"
seo_description: "Students investigate taxi pricing structures (flag fall plus per-km rate), compare companies, and advise which is cheapest for different distances."
teacher_moves:
...
parent_summary: 'Your child is working on "Modelling Taxi Fares". a mathematics investigation designed for Grade 6 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students investigate taxi pricing structures (flag fall plus per-km rate), compare companies, and advise which is cheapest for different distances.

...
hook: "Students track their own screen time for a week, analyse the data, compare to health recommendations, and write a person"
seo_title: "The Screen Time Report | MYP Resource | LearnLattice"
seo_description: "Students track their own screen time for a week, analyse the data, compare to health recommendations, and write a personal reflection."
teacher_moves:
...
parent_summary: 'Your child is working on "The Screen Time Report" — a mathematics investigation designed for Grade 6 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students track their own screen time for a week, analyse the data, compare to health recommendations, and write a personal reflection.

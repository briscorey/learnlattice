...
teacher_moves:
  ...
  - title: "Make it a competition"
    description: "Which group's salt water nail rusts the most in 5 days? Students love checking their nails each morning. It builds routine observation habits."
listen_for:
  - level: "3-4"
    phrase: "The one in salt water rusted the most"
  - level: "5-6"
...
misconceptions:
  - myth: "Rust eats away at the metal"
    ...
    truth: "Rusting is ADDING oxygen. The rust (iron oxide) is heavier than the original iron. The metal appears to degrade because the oxide is flaky and weak."
  - myth: "Water causes rust"
    why: "We see rust on things left in the rain"
    truth: "Water alone does not cause rust. You need both water AND oxygen. A nail in boiled water (no dissolved oxygen) with oil on top will not rust."
sentence_starters:
  approaching:
    - "The nail in ___ rusted the most because..."
    - "I observed that..."
  meeting:
    - "Rusting requires both ___ and ___ because..."
    - "The control tube showed that..."
  exceeding:
    - "The chemical equation for rusting is..."
    - "Salt water accelerated rusting because..."
self_check:
  - level: "Getting started"
    items:
      - "I set up my test tubes correctly"
      - "I recorded observations each day"
  - level: "Building understanding"
    items:
      - "I identified which conditions caused the most rust"
      - "I can explain why both water and air are needed"
  - level: "Going deeper"
    items:
      - "I can explain why the rusty nail is heavier"
      - "I can suggest how to prevent rusting"
exit_ticket:
  - "Name the TWO things iron needs to rust."
  - "Why is a rusty nail heavier than a shiny nail?"
  - "Suggest one way to prevent a bicycle chain from rusting."
quick_check:
  - type: "recall"
    q: "What is the chemical name for rust?"
    a: "Iron oxide (Fe₂O₃)"
  - type: "apply"
    q: "A nail in boiled water with a layer of oil does not rust. Why not?"
...
differentiated:
  ...
  exceeding: "Write the word equation and symbol equation for rusting. Explain why salt water accelerates the reaction and suggest a controlled experiment to test the effect of salt concentration."
journal_prompts:
...
Hold two nails. One is shiny and new. One is covered in orange rust.

Put them on a balance. **The rusty nail is heavier.**

Something was *added* to the nail. Not removed. Where did the extra mass come from?
...
| Tube | Condition | What it tests |
|---|---|---|
| 1 | Tap water (half-filled) | Water + air |
| 2 | Tap water + layer of cooking oil on top | Water, no air |
| 3 | Dry nail with cotton wool plug (desiccant if available) | Air, no water |
| 4 | Salt water (2 teaspoons per 100mL) | Water + air + salt |
| 5 | Nail wrapped in cling film, dry | No water, no air |

### Observe Daily

Every day for 5 days, observe each nail and record:
- Colour changes
- Amount of rust (none / slight / moderate / heavy)
...
After 5 days, rank your tubes from most rust to least rust.

> **The key finding:** Tubes 1 and 4 rusted. Tubes 2, 3, and 5 did not (or barely).

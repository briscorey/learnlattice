...
Place an unpeeled orange in a container of water. It floats.

Now peel the orange. Place the peeled orange in the water. **It sinks.**

Ask: **"You just removed material. It weighs less. Why does it sink now?"**

The room goes quiet. Then the theories start. This is the investigation.
...
2. A person with an average body density of 1.01 g/cm³ will float in the Dead Sea but might sink in a freshwater lake. Explain why, using the concept of density
3. Justify why the relationship between density and floating/sinking is a general principle that applies to ALL fluids, not just water (give an example from a different context)

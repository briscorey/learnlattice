...
hook: "Students use algebra to model the cost of a school trip with fixed and variable costs, determine break-even points, and "
seo_title: "Planning a School Trip Budget | MYP Resource | LearnLattice"
seo_description: "Students use algebra to model the cost of a school trip with fixed and variable costs, determine break-even points, and recommend pricing to the school cou"
teacher_moves:
...
parent_summary: 'Your child is working on "Planning a School Trip Budget". a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students use algebra to model the cost of a school trip with fixed and variable costs, determine break-even points, and recommend pricing to the school council.

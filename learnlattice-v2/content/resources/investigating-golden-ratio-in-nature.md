...
statement_of_inquiry: "Mathematical relationships in nature can be investigated through careful measurement and critical analysis of claims."
...
A critical investigation where students measure real objects and body proportions, calculate ratios, and evaluate the strength of the golden ratio claim.
...
- Length of finger sections (distal ÷ middle, middle ÷ proximal)
...
- Research: what do mathematicians actually say about the golden ratio in nature?

## Criterion B Alignment

| Strand | Evidence |
|--------|----------|
| Select a method | Choose measurement subjects, define "close enough" |
| Apply strategies | Systematic measurement, ratio calculation, percentage error |
| Describe patterns | Evaluate whether data supports or refutes the golden ratio claim |
| Verify | Apply critical thinking to distinguish genuine patterns from confirmation bias |

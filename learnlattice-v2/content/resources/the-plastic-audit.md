...
hook: "Students collect data on single-use plastic in their school, analyse patterns, compare to community data, and propose re"
seo_title: "The Plastic Audit | MYP Resource | LearnLattice"
seo_description: "Students collect data on single-use plastic in their school, analyse patterns, compare to community data, and propose reduction targets."
teacher_moves:
...
parent_summary: 'Your child is working on "The Plastic Audit". a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students collect data on single-use plastic in their school, analyse patterns, compare to community data, and propose reduction targets.

...
misconceptions:
  - myth: "All human development is bad for the environment"
    why: "Environmental messaging often focuses on damage"
    truth: "Some developments (renewable energy, sustainable agriculture) can reduce overall environmental harm. The question is not whether to develop but how to develop responsibly."
  - myth: "Ecosystems bounce back after the development is removed"
    why: "Students assume nature heals quickly"
...
sentence_starters:
  ...
  meeting:
    - "Biodiversity decreased from ___ to ___ species because..."
    - "The development benefited humans by ___ but harmed the ecosystem by..."
  exceeding:
    - "The cost-benefit analysis suggests that..."
    - "A mitigation strategy such as ___ could reduce the ecological impact while preserving..."
self_check:
  - level: "Getting started"
    items:
      - "I identified changes between the before and after data"
      - "I listed both human benefits and ecological costs"
  - level: "Building understanding"
    items:
      - "I quantified the changes using data"
      - "I evaluated whether the trade-offs were justified"
  - level: "Going deeper"
    items:
      - "I suggested evidence-based mitigation strategies"
      - "I considered long-term and indirect impacts"
exit_ticket:
  - "Name one way the development in our case study benefited humans."
  - "Name one measurable ecological impact of the development."
  - "Suggest one strategy that could have reduced the environmental damage while keeping the human benefit."
quick_check:
  - type: "recall"
    q: "What does 'biodiversity' measure?"
    a: "The variety and number of different species in an ecosystem."
  - type: "apply"
    q: "A forest had 45 bird species before a highway was built through it. After construction, 28 species were recorded. Calculate the percentage decrease."
    a: "(45-28)/45 × 100 = 37.8% decrease in bird species diversity."
  - type: "extend"
    q: "Why might species count decrease MORE in the years after construction finishes than during construction?"
    a: "Habitat fragmentation isolates populations, reducing genetic diversity and preventing migration. Edge effects change conditions deep into remaining forest. These long-term effects continue after building stops."
differentiated:
  approaching: "Compare the before and after images. List 5 changes. For each change, state whether it helped humans, harmed the ecosystem, or both."
...
seo_title: "Before and After | Human Impact on Ecosystems | MYP Science Grade 8"
seo_description: "Free MYP Science investigation for Grade 8. Students analyse satellite images and biodiversity data to evaluate human impact on ecosystems."
---

## The Hook

Two satellite images. Same location. Twenty years apart.

In the first image: a winding river, dense forest, green everywhere.

In the second: a dam, a reservoir, roads, cleared land, a town.

The valley was home to 200+ species. Now it is home to 50,000 people.
...
Compare before-and-after images of a major development. Use Google Earth Timelapse or printed satellite photos.

Record every visible change:
- Land cover (forest → cleared, wetland → drained)
- Water features (river diverted, lake created)
- Human structures (roads, buildings, dams)
- Vegetation patterns

### Step 2: Analyse the Data

Your teacher will provide data sets for the case study location:
...
- Propose **realistic mitigation strategies** based on evidence
- Consider **who benefits and who bears the cost**
...
The structured debate format works well: divide the class in half, one side argues FOR the development, the other AGAINST. Then swap sides. Students who have to argue the opposite position develop deeper understanding.

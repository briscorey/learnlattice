...
hook: "Students compare different phone plans with monthly fees and per-minute charges, setting up linear equations to determin"
seo_title: "The Mobile Phone Plan Problem | MYP Resource | LearnLattice"
seo_description: "Students compare different phone plans with monthly fees and per-minute charges, setting up linear equations to determine which plan is cheapest."
teacher_moves:
...
parent_summary: 'Your child is working on "The Mobile Phone Plan Problem". a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students compare different phone plans with monthly fees and per-minute charges, setting up linear equations to determine which plan is cheapest.

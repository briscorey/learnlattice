...
Place a small Bluetooth speaker face-up on a desk. Cover it with cling film stretched tight. Sprinkle salt on top of the cling film.

Play a single low-frequency tone (try 100 Hz from a tone generator app). The salt jumps and dances into patterns.

Change the frequency. The patterns change.
...
2. Sketch the salt pattern at each frequency

...
## Core Concept: Place Value as Multiplicative Structure

The fundamental insight students need to develop is this: **each step in our place value system represents a multiplication by 10, not an addition of 10**.

### Step-by-step: Building the scale

| Amount | Words | Seconds to spend it | In other units |
|--------|-------|-------------------|----------------|
| $1,000 | One thousand | 1,000 seconds | ~17 minutes |
| $1,000,000 | One million | 1,000,000 seconds | ~11.6 days |
| $1,000,000,000 | One billion | 1,000,000,000 seconds | ~31.7 years |
| $1,000,000,000,000 | One trillion | 1,000,000,000,000 seconds | ~31,700 years |

> **Formative checkpoint:** Ask students to explain in writing why there's such a large gap between million and billion. Many will say "a billion is a lot more." Push for precision: a billion is *one thousand times* more than a million. That multiplicative relationship is what they need to articulate.

### Introducing scientific notation

Students encounter scientific notation as a *solution to a real problem*: writing and comparing these numbers by hand is unwieldy and error-prone. Notation follows need.
...
- Stars in the observable universe: ~2 × 10²³
- Cells in the human body: ~3.7 × 10¹³
- Age of the universe in seconds: ~4.3 × 10¹⁷
- Number of heartbeats in a lifetime: ~3 × 10⁹
...
3. Write a paragraph explaining what a reader who doesn't understand scale might misinterpret, and what a more accurate comparison would look like.
...
|------|--------------|-----------|
| Part A problem-solving | Criterion A | Knowing and understanding: applying concepts correctly in context |
| Part B comparison and ratios | Criterion B | Investigating patterns: recognising and explaining mathematical relationships |
| Part C written explanation | Criterion D | Applying mathematics in real-world contexts: justifying reasoning for an audience |

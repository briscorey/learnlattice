...
hook: "Students collect and analyse nutritional data from the school canteen, compare to recommended daily intakes, and present"
seo_title: "Is Our School Canteen Healthy? | MYP Resource | LearnLattice"
seo_description: "Students collect and analyse nutritional data from the school canteen, compare to recommended daily intakes, and present findings with recommendations."
teacher_moves:
...
parent_summary: 'Your child is working on "Is Our School Canteen Healthy?". a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students collect and analyse nutritional data from the school canteen, compare to recommended daily intakes, and present findings with recommendations.

...
listen_for:
  - level: "3-4"
    phrase: "You get one coin from each parent"
  - level: "5-6"
...
sentence_starters:
  approaching:
    - "When I flipped both coins, the most common result was..."
    - "The pattern in the class data shows..."
  meeting:
    - "The 3:1 ratio happens because..."
    - "Siblings look different because..."
  exceeding:
    - "With n genes, the number of possible combinations is..."
    - "The Punnett square predicts probabilities, not certainties, because..."
self_check:
  - level: "Getting started"
    items:
      - "I flipped coins and recorded the outcomes"
      - "I compared my results to the class total"
  - level: "Building understanding"
    items:
      - "I can explain what dominant and recessive mean"
      - "I can draw a Punnett square for one gene"
  - level: "Going deeper"
    items:
      - "I can explain why the ratio is 3:1"
      - "I can explain why siblings are different"
exit_ticket:
  - "Two parents both carry one dominant (B) and one recessive (b) allele. What fraction of their children do you predict will show the recessive trait?"
  - "Why do identical twins look the same but non-identical twins can look very different?"
quick_check:
  - type: "recall"
    q: "What do we call the different versions of a gene?"
    a: "Alleles"
  - type: "apply"
    q: "A plant with genotype Tt is crossed with a plant with genotype tt. What are the possible offspring genotypes?"
...
differentiated:
  ...
  exceeding: "Calculate how many unique genetic combinations are possible with 3, 4, then n genes. Explain why no two siblings (except identical twins) are genetically identical."
journal_prompts:
  - "What trait do people say you inherited from your parents? Now that you understand genetics, what do you think is actually happening?"
...
People say you have your mother's eyes. Your father's nose. Your grandmother's curly hair.
...
## Part 1: One Gene, Two Coins

Each coin represents one parent. Heads = dominant allele (B). Tails = recessive allele (b).

**Flip both coins together 20 times. Record each result:**

| Outcome | Genotype | What it looks like | Tally | Total |
|---|---|---|---|---|
| Both heads | BB | Dominant trait (e.g. brown eyes) | | |
| One head, one tail | Bb | Dominant trait (carrier) | | |
| Both tails | bb | Recessive trait (e.g. blue eyes) | | |

> **Prediction:** Before you start, what ratio do you expect? Write it down.

### Class Data

Pool everyone's results on the board. With 500+ flips, the ratio should approach **3:1** (dominant : recessive).

> This is the same ratio Gregor Mendel found with pea plants in 1866. He did not know about DNA. He just counted very, very carefully.

---

## Part 2: Why Siblings Are Different

Now use **two pairs** of coins. Each pair represents one gene.

- Pair 1: Hair (Heads = dark, Tails = light)
- Pair 2: Freckles (Heads = freckles, Tails = no freckles)

Flip all four coins 10 times. Record the combination each time.

> **How many unique combinations did you get out of 10 flips?**

With just 2 genes, there are 9 possible combinations. With 3 genes, there are 27. With 20,000 genes (the human genome), the number of possible combinations from two parents is greater than the number of atoms in the observable universe.
...
The coin flips gave you the data. The Punnett square explains the data.

Draw a 2×2 grid. Put one parent's alleles across the top, the other down the side. Fill in the combinations.

...
**MYP Quest** is a platformer where each theme has unique mechanics and knowledge gates. Choose a topic, navigate the platforms, answer questions at gate checkpoints, and reach the exit portal.

### Controls

- **Arrow keys** or **WASD** to move
- **Up / W / Space** to jump (double jump available)
...
Levels get harder as you climb: narrower platforms, more hazards, additional knowledge gates (up to 3 per level), moving and special platforms from level 3+, and platform hazards from level 3+. Wrong answers at gates knock you back with a hint explaining the misconception.

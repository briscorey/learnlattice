...
parent_summary: 'Your child is working on "The Packaging Redesign Challenge" — a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students measure existing product packaging, calculate material waste, and redesign the package to minimise surface area while maintaining volume.

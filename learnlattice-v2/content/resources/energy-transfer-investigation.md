...
duration: "2 lessons"
seo_title: "Where Does the Energy Go? | MYP Criterion B Physics"
...
Write every student answer on the board. You will get: "friction," "air," "heat," "sound," "the floor," "it runs out." All of these contain a grain of truth. None of them are complete. This investigation is about building the complete picture.
...
The total energy in the system has not changed. But the *useful* energy (kinetic energy that makes the ball bounce high) has decreased because some has been transferred to less useful forms (thermal, sound).

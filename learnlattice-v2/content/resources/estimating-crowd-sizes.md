...
statement_of_inquiry: "Mathematics becomes powerful when applied to real situations, requiring us to model, calculate, and reflect on our answers."
difficulty: "meeting"
duration: "1–2 lessons"
hook: "Students investigate methods for estimating large quantities (crowd sizes at events), applying sampling and proportional"
seo_title: "Estimating Crowd Sizes | MYP Resource | LearnLattice"
seo_description: "Students investigate methods for estimating large quantities (crowd sizes at events), applying sampling and proportional reasoning to aerial photos."
teacher_moves:
  - title: "Hook first, instructions second"
    description: "Present the problem or question before distributing any materials or worksheets. Let students sit with the question for 60 seconds before you say anything else."
...
- myth: "To double a recipe, add the same amount again"
  ...
  truth: "Doubling means multiplying every ingredient by 2. Adding the same amount only works if the original was exactly half."
- myth: "If one quantity doubles, the other always doubles"
  why: "Students overgeneralise proportional reasoning"
  truth: "This is only true for directly proportional relationships. Many real-world relationships are not proportional."
self_check:
...
parent_summary: 'Your child is working on "Estimating Crowd Sizes" — a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students investigate methods for estimating large quantities (crowd sizes at events), applying sampling and proportional reasoning to aerial photos.

## The Investigation

### The Context
Students encounter the real-world problem and identify which mathematical tools are needed.

### Setting Up the Model
Translate the real situation into mathematical language: variables, equations, diagrams.

### Solving and Interpreting
Apply mathematical skills to find solutions, then interpret what the numbers mean in context.

### Reflecting
Evaluate: Does the answer make sense? What are the limitations? How could the model be improved?

## Criterion Alignment

| Strand | What Students Do |
|--------|-----------------|
| Identify the real-world problem | Identify the real-world problem and relevant mathematical content |
| Select appropriate mathematics/science | Select and set up appropriate mathematical models |
| Apply to the context | Apply mathematics accurately and interpret results in context |
| Reflect on reasonableness | Evaluate the reasonableness of the solution and discuss limitations |

## EAL Scaffolds

- **Sentence frame**: 'The mathematics shows that... This makes sense because... However, this model doesn't account for...'
- **Word bank**: model, estimate, approximate, reasonable, limitation, assumption, context

## Differentiation
- **Approaching**: Guided setup with provided variables and equations
- **Meeting**: Open modelling with scaffolded reflection prompts
- **Exceeding**: Compare multiple models, evaluate trade-offs, present recommendations

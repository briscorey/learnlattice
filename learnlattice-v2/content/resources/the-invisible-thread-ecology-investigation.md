...
Show this sequence of facts. One per minute. No explanation between them.

**Fact 1:** In 1900, sea otters along the California coast were nearly hunted to extinction for their fur.

**Fact 2:** Sea urchin populations exploded.

**Fact 3:** Sea urchins eat kelp holdfasts. Entire kelp forests were grazed to bare rock.

**Fact 4:** Without kelp forests: sea bass, rockfish, and sheepshead populations collapsed. Harbor seals declined. Bald eagle populations along the coast fell.

**Fact 5:** Kelp forests were restored when sea otter populations recovered under legal protection in the 1970s.

Ask: **"How many species were affected by the hunting of sea otters?"**

Students typically answer: "A few." The actual answer is: dozens. And the otter never directly touched most of them.
...
- **Primary consumers** (level 2): herbivores eating producers
...
1. Identify the apex predator: wolves
2. Direct effect: wolves hunt elk
3. First-order indirect effect: elk population declines *and* elk avoid riverbeds
4. Second-order indirect effect: willows, aspen, and cottonwood regenerate along riverbanks
5. Third-order indirect effect: tree roots stabilise banks, beavers return, river channels narrow and deepen
6. Fourth-order indirect effect: beaver dams create ponds, increasing habitat for fish, waterfowl, and amphibians

The river changed. The wolves never touched a river.

### Limiting Factors

A **limiting factor** is any resource or condition that constrains the growth of a population when it is in short supply, regardless of the abundance of other resources.
...
For each scenario below, trace the cascade effects through the food web. For each species affected, write whether the population would *increase*, *decrease*, or *uncertain*, and explain the chain of causation.

**Scenario 1:** Herring are overfished and their population drops by 80%.

**Scenario 2:** A disease kills 60% of the sea urchin population.
...
**Your task:**
1. Using trophic cascade reasoning, predict the ecological effects of wolf reintroduction to the Highlands. Be specific: which species would be affected, and via which pathways (direct predation? Behavioural change? Vegetation recovery?)?
2. Write the strongest possible argument *against* wolf reintroduction from the perspective of a hill farmer whose sheep are at risk.
...
|------|--------------|-----------|
| Part A cascade analysis | Criterion B | Inquiring and designing: identifying variables and predicting outcomes in a complex system |
| Part B nitrogen detective | Criterion B + C | Identifying patterns in data and justifying conclusions |
| Part C rewilding debate | Criterion D | Reflecting and evaluating: applying ecological reasoning to a real-world conservation decision |
| Part D fisheries synthesis | Criterion D | Applying science to evaluate a complex real-world problem with genuine uncertainty |

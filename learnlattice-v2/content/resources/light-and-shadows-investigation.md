...
Go outside. Ask every student to stand in the same spot and measure their shadow at 9am, 12pm, and 2pm (or set up a stick and measure three times during the school day).

Three measurements. Three very different shadow lengths. Same stick. Same sun.

Ask: **"Why does the shadow change? Can you predict how long it will be at 4pm?"**
...
### Data Collection
Plant a metre stick vertically in the ground (or tape it to a flat surface in sunlight). Every hour from 9am to 3pm:
1. Measure the shadow length (cm)
2. Measure the angle of the Sun above the horizon (using a clinometer or protractor)

...
statement_of_inquiry: The relationship between depth and pressure follows a predictable pattern that explains phenomena from ear pain to engineering design.
...
hook: What makes why do your ears pop? worth investigating?
warmup: 'Show students a simple example related to why do your ears pop?. Ask: What do you notice? What do you wonder? Give 2 minutes for pair discussion.'
...
listen_for:
- level: 3-4
  phrase: Describes observations about why do your ears pop? without explanation
- level: 5-6
...
- q: What is the key question this investigation explores?
  a: Students should reference the central question of Why Do Your Ears Pop?
  type: recall
...
journal_prompts:
- Explain why do your ears pop? to someone who hasn't studied it. What would you say?
...
seo_title: "Why Do Your Ears Pop? | MYP Physics Crit B & Crit D | Grade 8-9"
seo_description: "Free MYP Physics investigation pack targeting Criterion B, Criterion D for Grade 8-9. Dive underwater and your ears hurt. Fly in a plane and they "
---
...
The answer is pressure. But students need to discover that the *same concept* explains all three.
...
2. Record the height of water above each hole
...
|---|---|---|
| "Pressure only pushes downward" | Pressure in fluids acts in all directions | The bottle holes demonstrate sideways pressure |
| "Air doesn't have pressure" | Atmospheric pressure is ~101 kPa | The chip bag on a plane makes this visible |
| "Heavier objects feel more pressure" | Pressure depends on depth, not the object's weight | Two divers at the same depth feel the same pressure |

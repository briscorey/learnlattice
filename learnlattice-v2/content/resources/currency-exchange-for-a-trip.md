...
hook: "Students plan a travel budget using real exchange rates, commission fees, and proportional reasoning to maximise spendin"
seo_title: "Currency Exchange for a Trip | MYP Resource | LearnLattice"
seo_description: "Students plan a travel budget using real exchange rates, commission fees, and proportional reasoning to maximise spending power."
teacher_moves:
...
parent_summary: 'Your child is working on "Currency Exchange for a Trip". a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students plan a travel budget using real exchange rates, commission fees, and proportional reasoning to maximise spending power.

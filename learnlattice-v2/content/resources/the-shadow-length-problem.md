...
hook: "Students use similar triangles and shadow measurements to calculate the height of buildings and trees that cannot be mea"
seo_title: "The Shadow Length Problem | MYP Resource | LearnLattice"
seo_description: "Students use similar triangles and shadow measurements to calculate the height of buildings and trees that cannot be measured directly."
teacher_moves:
...
parent_summary: 'Your child is working on "The Shadow Length Problem" — a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students use similar triangles and shadow measurements to calculate the height of buildings and trees that cannot be measured directly.

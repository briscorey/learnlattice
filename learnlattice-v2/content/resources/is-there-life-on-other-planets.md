...
statement_of_inquiry: "Determining whether a planet could support life requires defining what life needs, identifying the conditions that provide it, and evaluating evidence from systems we cannot directly observe."
formula: "Habitable zone: 0.95-1.37 AU from a Sun-like star (where liquid water is stable)"
...
teacher_moves:
  ...
  - title: "Real exoplanet data"
    description: "Use NASA's Exoplanet Archive (exoplanetarchive.ipac.caltech.edu) or a curated dataset. Students filter for rocky planets in the habitable zone. As of 2026, there are dozens of candidates. Each must be evaluated."

hints:
  - "What three things does life on Earth need? Do all living things on Earth need the same things?"
  - "Mars is in the habitable zone of our Sun. Why is it not habitable today?"
  - "If a planet is the right distance from its star, is that enough for life? What else matters?"
  - "How do scientists detect planets around other stars if they cannot see them directly?"

difficulty: "exceeding"
duration: "2–3 lessons"
hook: "Scientists have found 5,000+ planets orbiting other stars. Some are in the habitable zone. Are any of them alive?"
self_check:
- level: Getting started
  items:
  - I can list the conditions needed for life as we know it
  - I can describe what the habitable zone is
- level: Building understanding
  items:
  - I can explain why being in the habitable zone is necessary but not sufficient for life
  - I can identify habitable zone planets from a dataset
- level: Going deeper
  items:
  - I can evaluate specific exoplanets using multiple criteria beyond distance
  - I can explain how scientists detect exoplanets without seeing them directly
- level: Pushing further
  items:
  - I can discuss the limitations of our ability to detect life remotely
  - I can evaluate the philosophical and scientific implications of finding life elsewhere
misconceptions:
- myth: "Any planet in the habitable zone has life"
  why: "The name 'habitable zone' implies habitability"
  truth: "The habitable zone is where liquid water COULD exist on the surface. Many other factors determine whether a planet is actually habitable: atmosphere, magnetic field, plate tectonics, axial tilt, and more. Mars is in our habitable zone but is currently not habitable."
- myth: "Life requires Earth-like conditions"
  why: "Earth is the only example we have"
...
sentence_starters:
  ...
  - "This exoplanet is a candidate for habitability because..."
  explaining:
  - "Being in the habitable zone is necessary but not sufficient because..."
  - "Scientists can detect the composition of an exoplanet's atmosphere by..."
  justifying:
  - "Of the candidates analysed, the most promising is... because..."
  - "The search for extraterrestrial life is scientific (not just speculative) because..."
warmup: "You discover a new planet. It is the same size as Earth, the same distance from its star as Earth is from the Sun. Is it habitable? What else would you need to know?"
listen_for:
- level: 3-4
...
This is not science fiction. This is the research question driving a major branch of modern astrophysics. And today, students will do what real astrobiologists do: define what life needs, identify candidate planets, and evaluate the evidence.
...
<div class="tm-phase">
  ...
  <div class="tm-phase-body">
    <div class="tm-phase-title">What does life need?</div>
    <p>Groups brainstorm on whiteboards: what does life need? Accept all answers. Then refine: liquid water (universal solvent), energy source (sunlight or chemical), organic molecules (carbon chemistry), stable conditions (enough time for evolution). These are the criteria for evaluation. Note: these are based on life as we know it. Life elsewhere might have different requirements.</p>
  </div>
</div>
...
<div class="tm-phase">
  ...
  <div class="tm-phase-body">
    <div class="tm-phase-title">The habitable zone</div>
    <p>Draw a star on the board. Draw concentric circles. Too close: any water boils. Too far: any water freezes. The zone in between: liquid water is possible. For our Sun, this is about 0.95 to 1.37 AU. Venus is at the inner edge (too hot now). Mars is at the outer edge (too cold now, but maybe not always). Earth is perfectly placed.</p>
  </div>
</div>

<div class="tm-phase">
  <span class="tm-phase-time">25–40 min</span>
  <div class="tm-phase-body">
    <div class="tm-phase-title">Exoplanet data analysis</div>
    <p>Give groups a curated dataset of 20 confirmed exoplanets with: name, radius (Earth radii), orbital distance (AU), star type, estimated temperature, and whether an atmosphere has been detected. Task: rank these from most to least likely to be habitable. Justify every ranking using the criteria developed earlier.</p>
  </div>
</div>
...
The search for extraterrestrial life is one of the defining scientific endeavours of the 21st century. The James Webb Space Telescope is already analysing exoplanet atmospheres for biosignatures. Within students' lifetimes, we may have a definitive answer.

This investigation teaches the scientific method applied to the biggest question possible: students define criteria, gather data, evaluate evidence, and acknowledge uncertainty. The subject matter captures attention; the methodology teaches rigour.

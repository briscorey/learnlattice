...
Boil red cabbage for 10 minutes. Strain the purple liquid into 6 glasses.

Add a different household substance to each: lemon juice, vinegar, baking soda, soap, milk, tap water.
...
3. Arrange your tubes in order from most acidic (pink) to most basic (green)

| Substance | Colour | Acid, neutral, or base? |
|---|---|---|
| Lemon juice | | |
| Vinegar | | |
| Tap water | | |

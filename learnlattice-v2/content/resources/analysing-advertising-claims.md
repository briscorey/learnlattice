...
hook: "Students collect examples of statistical claims in advertisements, evaluate the methodology, identify misleading graphs,"
seo_title: "Analysing Advertising Claims | MYP Resource | LearnLattice"
seo_description: "Students collect examples of statistical claims in advertisements, evaluate the methodology, identify misleading graphs, and write a consumer guide."
teacher_moves:
...
parent_summary: 'Your child is working on "Analysing Advertising Claims". a mathematics investigation designed for Grade 8 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students collect examples of statistical claims in advertisements, evaluate the methodology, identify misleading graphs, and write a consumer guide.

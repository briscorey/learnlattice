...
hook: "Students survey classmates about sleep habits, analyse the data, compare to health guidelines, and make evidence-based r"
seo_title: "The Sleep Investigation | MYP Resource | LearnLattice"
seo_description: "Students survey classmates about sleep habits, analyse the data, compare to health guidelines, and make evidence-based recommendations."
teacher_moves:
...
parent_summary: 'Your child is working on "The Sleep Investigation" — a mathematics investigation designed for Grade 7 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

Students survey classmates about sleep habits, analyse the data, compare to health guidelines, and make evidence-based recommendations.

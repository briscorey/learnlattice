...
listen_for:
  - level: "3-4"
    phrase: "One gas made a pop sound and the other relighted a glowing splint"
  - level: "5-6"
    phrase: "Water is a compound of hydrogen and oxygen. Electrolysis uses electricity to break the bonds and separate them. The 2:1 ratio matches the formula H₂O."
  - level: "7-8"
    phrase: "At the cathode, H⁺ ions gain electrons (reduction) to form H₂ gas. At the anode, OH⁻ ions lose electrons (oxidation) to form O₂ and water. The overall equation is 2H₂O → 2H₂ + O₂."
misconceptions:
...
sentence_starters:
  approaching:
    ...
    - "The gas test showed that..."
  meeting:
    - "The 2:1 ratio of hydrogen to oxygen matches the formula H₂O because..."
    - "Electrolysis proves that water is a compound, not an element, because..."
  exceeding:
    - "At the cathode, reduction occurs: ..."
    - "The energy for breaking the bonds comes from..."
self_check:
  - level: "Getting started"
    items:
      - "I set up the apparatus safely"
      - "I collected gas at both electrodes and tested them"
  - level: "Building understanding"
    items:
      - "I identified which gas formed at each electrode"
      - "I can explain the 2:1 volume ratio"
  - level: "Going deeper"
    items:
      - "I can write the balanced equation for electrolysis of water"
      - "I can explain oxidation and reduction at each electrode"
exit_ticket:
  - "Name the gas collected at each electrode and state the test for each."
  - "Why does twice as much gas collect at the negative electrode?"
  - "Why does electrolysis prove that water is a compound?"
quick_check:
  - type: "recall"
    q: "Write the balanced equation for the electrolysis of water."
    a: "2H₂O → 2H₂ + O₂"
  - type: "apply"
...
differentiated:
  ...
  exceeding: "Explain the electrode reactions using oxidation and reduction. Research why the electrolyte is needed and why it is not consumed. Evaluate the potential of electrolysis for hydrogen fuel production."
journal_prompts:
...
- Electrolysis apparatus (Hoffman voltameter or simple setup with two test tubes, graphite electrodes, and a power supply)
- DC power supply (6-12V)
- Dilute sulfuric acid or sodium hydroxide solution (electrolyte)
- Wooden splints and matches
- Safety goggles

### Method

1. Fill the apparatus with water + a few drops of electrolyte
2. Connect the electrodes to the DC power supply
3. Turn on at 6V. Observe: bubbles should appear at both electrodes
4. Collect gas in the inverted tubes above each electrode
5. When tubes are full, carefully remove them for testing

### Gas Tests

**Tube from the negative electrode (cathode):**
Hold a lit splint to the mouth of the tube. If you hear a **squeaky pop** → **hydrogen**

**Tube from the positive electrode (anode):**
Light a splint, blow it out so it glows, and insert it into the tube. If the glowing splint **relights** → **oxygen**
...
Electrolysis means "splitting with electricity." The electrical energy breaks the bonds holding hydrogen and oxygen together.

At the **cathode** (negative): hydrogen ions gain electrons → hydrogen gas

...
statement_of_inquiry: "Consistent mathematical relationships emerge when we systematically measure and compare properties of similar shapes."
difficulty: "meeting"
...
| Strand | Evidence |
|--------|----------|
| Select a method | Design data collection procedure |
| Apply strategies | Systematic measurement, ratio calculation |
| Describe patterns | Identify the constant ratio across all circles |
| Verify | Compare experimental mean to known value of π |

...
parent_summary: 'Your child is working on "Grade 8 Plate Tectonic Theory Companion Investigation Pack" — a earth science investigation designed for Grade 8 students. They are learning to find patterns, test ideas, and explain their reasoning. Ask them: what did you discover, and how do you know it works?'
---

## Overview

This companion investigation pack extends [Grade 8 Plate Tectonic Theory Unit]() with a tighter evidence-collection cycle, student recording structures, and follow-up prompts that keep the inquiry focused on explanation rather than procedure.

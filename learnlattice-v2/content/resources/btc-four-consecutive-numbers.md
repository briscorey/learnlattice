...
statement_of_inquiry: "Patterns in numbers reveal algebraic structures that can be proved to hold universally."
difficulty: "meeting"
duration: "1 lesson"
...
Pick any four consecutive numbers. Add them.
...
> **What is always true about the sum?** Test at least 5 examples before you make a conjecture.

---

## Deepen the Investigation

Once you have a conjecture:

1. **Can you explain WHY it works using the structure of consecutive numbers?**
2. If n is the first number, write the four numbers algebraically: n, n+1, n+2, n+3
3. Add them. Simplify. What does the algebra reveal?
4. Does this work for THREE consecutive numbers? FIVE? What pattern do you see in the patterns?

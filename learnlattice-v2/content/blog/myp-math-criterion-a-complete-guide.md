...
**Levels 1-2 (Limited):** The student can recall basic facts and definitions when prompted. They might identify that a problem involves algebra, but cannot set up or solve the equation. Work contains frequent errors in routine procedures.

**Levels 3-4 (Adequate):** The student applies mathematical concepts to solve familiar problems. They can follow a method and get the right answer in contexts they have practised. Errors appear when the problem is presented differently from what they have seen before.

**Levels 5-6 (Substantial):** The student solves problems in both familiar and unfamiliar situations. They select appropriate methods without being told which to use. Working is mostly correct, and they can explain their reasoning.

**Levels 7-8 (Excellent):** The student solves complex problems across a variety of contexts, selecting and applying mathematics flexibly. They demonstrate understanding of *why* methods work, not just *how* to use them. Errors are rare and self-corrected.
...
The most common mistake in Criterion A assessment is testing recall disguised as understanding. A task that asks students to "solve these 20 equations" tests procedural fluency, not understanding. To genuinely assess Criterion A, include problems that require students to select the method (not just apply one they have been told to use), work in unfamiliar contexts, and explain their reasoning.
...
## Criterion A and EAL Students

For English as an Additional Language learners, Criterion A presents a paradox: the mathematical knowledge may be strong, but word problems create a language barrier that obscures understanding. Three strategies help:

First, use visual and numerical entry points before introducing word problems. A student who can solve a problem presented as a diagram or equation may struggle with the same problem embedded in a paragraph of English.

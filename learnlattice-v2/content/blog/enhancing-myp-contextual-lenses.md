...
What is new is the explicit invitation to frame your unit through one or more of these lenses:

**Individual:** How does this affect me personally? What can I observe in my own experience?

**Local:** How does this play out in our school, city, or region? What data can we collect from our community?

**Global:** How does this operate at a planetary or systemic level? What patterns emerge across countries and cultures?

## Why Lenses Matter More Than They Seem

The contextual lenses solve a real problem: global contexts were often applied at the wrong scale, making them feel forced.

Consider a Grade 7 statistics unit. The global context is "Fairness and Development." Without a lens, teachers might default to something vague: "Statistics helps us understand fairness." This is true but generates no inquiry energy.
...
**Students can take action.** The local lens creates natural opportunities for community engagement (the Enhanced MYP's replacement for Service as Action). If students discover that the school's recycling programme captures only 30% of recyclable waste, they have both the data and the motivation to propose improvements.
...
| Lens | Inquiry Question | Data Source | Criterion D Focus |
|---|---|---|---|
| Individual | How much water do I actually use in a day? Can I reduce it by 20%? | Personal water diary for one week | Personal behaviour change |
| Local | Does our school use more water per student than the city average? | School utility bills + city data | Recommendation to administration |
| Global | If every person on Earth used water at the Australian rate, how many Earths would we need? | World Bank water use data by country | Global inequality in resource use |
...
| Lens | Inquiry Question | Activity | Criterion D Focus |
|---|---|---|---|
...
There is no requirement to use all three lenses across a programme, though doing so provides variety and develops different types of thinking. Here are some guidelines:

**Use the individual lens when** the content connects directly to students' personal experience, health, or identity. Particularly powerful for data collection units where students are the data source.

**Use the local lens when** you want students to investigate their own environment and potentially take action. Best for fieldwork, surveys, and community-based projects. This lens produces the strongest Criterion D (both maths and science) because students can evaluate real-world impact in their own context.

**Use the global lens when** the content addresses large-scale systems, cross-cultural comparisons, or issues that require understanding of global patterns. Best for units where published data is the primary source.

**Combine lenses when** the unit naturally escalates from personal to global. A nutrition unit might start with individual dietary analysis (individual), compare to school cafeteria nutritional data (local), and evaluate global food security statistics (global).
